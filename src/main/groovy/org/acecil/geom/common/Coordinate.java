 ...
 */
package org.acecil.geom.common;
...
public class Coordinate implements Comparable<Object>, Cloneable, Serializable {
	...
	/**
	 * Gets the ordinate value for the given index. The supported values for the
	 * index are {@link X}, {@link Y}, and {@link Z}.
	 * 
	 * @param ordinateIndex
	 *            the ordinate index
	...
	/**
	 * Sets the ordinate for the given index to a given value. The supported
	 * values for the index are {@link X}, {@link Y}, and {@link Z}.
	 * 
	 * @param ordinateIndex
	 *            the ordinate index
	 * @param value
	...
	public double distanceSquare(Coordinate p) {
		double dx = x - p.x;
		double dy = y - p.y;
